...
<div class="main_div">
     ...
     <div class="container">
        <div class="row">
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:76px;background-color:#30bdc9;border-radius:10px;color:white" >
              <form method="POST">  
                                              
 <?php
include 'connection.php';
$ids=$_GET['idtransfer'];
$showquery="select * from `customersdetails` where ID=($ids) ";
...
?> 
                    ...
                    <h3>Transfer Details</h3>
                        ...
                        <img src="images/4.jpg" style="width:130px;height:60px;">
                    </div>
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:60px;height:380px;">
                   <div class="card-body">
                   <img src="images/4.jpg" style="width:250px;height:220px;margin-top:40px;">
...
if(isset($_POST['submit']))
{
    ...
    $ids=$_GET['idtransfer'];
    $senderquery="select * from `customersdetails` where ID=$ids ";
    ...
    //receiverquery
    $receiverquery="select * from `customersdetails` where Email='$Receiver_email' ";
    ...
    if($arrdata['AMOUNT'] >= $Sender)
    {
      ...
      $increase_receiver=$receiver_arr['AMOUNT'] + $Sender;
       $query="UPDATE `customersdetails` SET `ID`=$ids,`AMOUNT`= $decrease_sender  where `ID`=$ids ";
       $rec_query="UPDATE`customersdetails` SET `ID`=$id_receiver,`AMOUNT`= $increase_receiver where  `ID`=$id_receiver ";
