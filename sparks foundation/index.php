...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="#" class="navbar-brand font-weight-bold text-white text-center"><h2>ONLINE PAY</h2></a>
     ...
     <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6">
            <h1 class="main_text">ONLINE PAY</h1>
            <p class="big-text">Let's pay online</p>
          </div>

          <div class="col-sm-6">
            
            <img src="images/1.jpg" class="img-fluid" width="560" height="345" style="margin-top:20px;">
